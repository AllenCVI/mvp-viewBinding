...
public class WheelView extends View implements IWheelViewSetting {
    ...
    private float textSizeFinal=0.0f;
    ...
    public void setSelectedIndex(int targetIndexPosition, boolean withAnimation) {
        ...
        if (withAnimation) {
            ...
            if (onSelectedListener != null)
                onSelectedListener.onSelected(getContext(), selectedIndex,this);
        }
    }
        ...
        if (animator == null) {
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (onSelectedListener != null)
                        onSelectedListener.onSelected(getContext(), selectedIndex,WheelView.this);
                }
    ...
    private int calAlpha(Rect rect) {
        ...
        float alpha = 0.8f * distance / totalDistance;
        if(alpha==0){
            textPaint.setTextSize((float) (textSizeFinal*1.5));
        }else {
            textPaint.setTextSize(textSizeFinal);
        }
    ...
    public interface OnSelectedListener {
        void onSelected(Context context, int selectedIndex,WheelView wheelView);
    }
}
