...
//    }
    ...
    public static List<VideoInfoBean> tiktokData;

    public static List<VideoInfoBean> getTiktokDataFromAssets(Context context) {
        try {
            if (tiktokData == null) {
                ...
                tiktokData = VideoInfoBean.arrayTiktokBeanFromData(result);
            }
            return tiktokData;
        } catch (IOException e) {
            e.printStackTrace();
