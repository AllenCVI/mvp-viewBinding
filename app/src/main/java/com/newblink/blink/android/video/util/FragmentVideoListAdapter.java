...
public class FragmentVideoListAdapter extends PagerAdapter {
    ...
    public FragmentVideoListAdapter(List<VideoInfoBean> videoBeans) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_video_item, container, false);
...
//        ImageLoaderUtil.loadCircleImgInNet(context,item.coverImgUrl,viewHolder.mThumb,android.R.color.black,android.R.color.black,20);
    ...
    public static class ViewHolder {
        ...
        public VideoListItemView mVideoListItemView;
        public FrameLayout mPlayerContainer;

        ViewHolder(View itemView) {
            mVideoListItemView = itemView.findViewById(R.id.video_item_view);
            mTitle = mVideoListItemView.findViewById(R.id.tv_title);
            mThumb = mVideoListItemView.findViewById(R.id.iv_thumb);
